...
if($('.mainmenu-area li.dropdown ul').length){
...
//Update Mainmenu Style and Scroll to Top
function mainmenustyle() {
    if($('.mainmenu-area').length){
        var windowpos = $(window).scrollTop();
        var siteHeader = $('.mainmenu-area');
        var scrollLink = $('.scroll-top');
        if (windowpos >= 1050) {
            siteHeader.addClass('fixed-header');
            scrollLink.fadeIn(300);
...
if ($('.project-carousel').length) {
    $('.project-carousel').owlCarousel({
        ...
        autoplay: true,
        autoplayTimeout:6000,
        navText: [ '<span class="fa fa-long-arrow-up"></span>', '<span class="fa fa-long-arrow-down"></span>' ],
        responsive:{
            0:{
                items:1
            },
...
// Vehicle Carousel RTL
if ($('.vehicle-carousel-rtl').length) {
    $('.vehicle-carousel-rtl').owlCarousel({
        loop: true,
        margin: 0,
        dots: false,
        nav: true,
...
if ($('.project-slider .bxslider').length) {
	$('.project-slider .bxslider').bxSlider({
        nextSelector: '.project-slider .slider-next',
        prevSelector: '.project-slider .slider-prev',
        ...
        moveSlides:1,
        speed: '1000',
        pagerCustom: '.project-slider .slider-pager .thumb-box'
    });
};
